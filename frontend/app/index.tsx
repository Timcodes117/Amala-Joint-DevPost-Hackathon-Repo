import { View, Text, Button, SafeAreaView, TouchableOpacity, Image, Dimensions } from "react-native";
...
export default function App() {
  ...
  const onboarding_details: { title: string, description: string, image: any }[] = [
    {
      ...
      image: require("../assets/images/amala.png")
    },
    {
    ...
    },
    {
      ...
      image: require("../assets/images/phone_map.png")
    },
  ]
  ...
  return (
    <SafeAreaView style={{
      ...
      flexDirection: "column", justifyContent: "space-between", backgroundColor: color_scheme.grey_bg
    }}>
      <View style={{
      ...
      <Image source={onboarding_details[currentIndex].image} resizeMode="contain"
      ...
      <View style={[onboarding_sheet.conatiner]}>
        ...
        {currentIndex >= 2 && <View style={[onboarding_sheet.centered, {
          width: "100%", flexDirection: "column", gap: 10, alignItems: "center", justifyContent: "space-between", marginBottom: 40,
        }]}>
          <WideButton onTap={() => router.push("(auth)/login")} type="outlined" >I already have an Account</WideButton>
          <WideButton onTap={() => router.push("(auth)/signup")} >Create an Account</WideButton>
